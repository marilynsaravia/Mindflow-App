export default function QuizHeader({
  ...
  return (
    <header className="w-full flex justify-stretch items-center ">
      <div className="flex items-center justify-between px-26 py-8 w-full ">
        ...
        <div className="flex items-center gap-3">
          <div className="flex flex-col text-right text-base font-medium">
            ...
            <span className="text-[#A3C0BD] text-xl leading-none">
              {userName}
            </span>
          </div>
